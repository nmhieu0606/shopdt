                                    ...
                                    <div class="d-lg-flex menu_banners">
                                        <div class="col-sm-4">
                                            <div class="header-banner">
                                                <img src="{{url('public/shopwise')}}/assets/images/menu_banner1.jpg" alt="menu_banner1">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="header-banner">
                                                <img src="{{url('public/shopwise')}}/assets/images/menu_banner2.jpg" alt="menu_banner2">
                                                <div class="banne_info">
                                                    <h6>15% Off</h6>
                                                    <h4>Men's Fashion</h4>
                                                    <a href="#">Shop now</a>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="header-banner">
                                                <img src="{{url('public/shopwise')}}/assets/images/menu_banner3.jpg" alt="menu_banner3">
                                                <div class="banne_info">
                                                    <h6>23% Off</h6>
                                                    <h4>Kids Fashion</h4>
                                                    <a href="#">Shop now</a>
                                                ...
                                                <div class="header_banner_content">
                                                    <div class="shop_banner">
                                                        <div class="banner_img overlay_bg_40">
                                                            <img src="{{url('public/shopwise')}}/assets/images/shop_banner.jpg" alt="shop_banner" />
                                                        </div>
                        ...
                        <div class="row shop_container list">
                                ...
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{url('public/shopwise')}}/assets/images/product_img1.jpg" alt="product_img1">
                                        </a>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{url('public/shopwise')}}/assets/images/product_img2.jpg" alt="product_img2">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{url('public/shopwise')}}/assets/images/product_img3.jpg" alt="product_img3">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{url('public/shopwise')}}/assets/images/product_img4.jpg" alt="product_img4">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{url('public/shopwise')}}/assets/images/product_img5.jpg" alt="product_img5">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{url('public/shopwise')}}/assets/images/product_img6.jpg" alt="product_img6">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{url('public/shopwise')}}/assets/images/product_img7.jpg" alt="product_img7">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{url('public/shopwise')}}/assets/images/product_img8.jpg" alt="product_img8">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{url('public/shopwise')}}/assets/images/product_img9.jpg" alt="product_img9">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{url('public/shopwise')}}/assets/images/product_img10.jpg" alt="product_img10">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{url('public/shopwise')}}/assets/images/product_img11.jpg" alt="product_img11">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="col-lg-3 col-md-4 col-6">
                                <div class="product">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{url('public/shopwise')}}/assets/images/product_img12.jpg" alt="product_img7">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
